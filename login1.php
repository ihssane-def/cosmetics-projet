...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "SELECT id, username, password FROM utilisateur WHERE username = ?";
    ...
    if ($stmt->num_rows > 0) {
        ...
        if (password_verify($password, $db_password)) {
            // Authentification réussie, enregistre les informations de l'utilisateur dans la session
